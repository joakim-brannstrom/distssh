...
version (Have_libasync)  : import eventcore.driver;
...
@safe: /*@nogc:*/ nothrow:
    ...
    override @property LibasyncEventDriverCore core() {
        return m_core;
    }

    override @property LibasyncEventDriverFiles files() {
        return m_files;
    }

    override @property LibasyncEventDriverSockets sockets() {
        return m_sockets;
    }

    override @property LibasyncEventDriverDNS dns() {
        return m_dns;
    }

    override @property LibasyncEventDriverTimers timers() {
        return m_timers;
    }

    override @property LibasyncEventDriverEvents events() {
        return m_events;
    }

    override @property shared(LibasyncEventDriverEvents) events() shared {
        return m_events;
    }

    override @property LibasyncEventDriverSignals signals() {
        return m_signals;
    }

    override @property LibasyncEventDriverWatchers watchers() {
        return m_watchers;
    }
...
@safe: /*@nogc:*/ nothrow:
    ...
    protected override void* rawUserData(StreamSocketFD descriptor, size_t size,
            DataInitializer initialize, DataInitializer destroy) @system {
        assert(false, "TODO!");
    }

    protected override void* rawUserData(DatagramSocketFD descriptor,
...
@safe: /*@nogc:*/ nothrow:
    ...
    override void read(StreamSocketFD socket, ubyte[] buffer, IOMode mode,
            IOCallback on_read_finish) {
        assert(false, "TODO!");
    }

    override void write(StreamSocketFD socket, const(ubyte)[] buffer, IOMode mode,
    ...
    override void receive(DatagramSocketFD socket, ubyte[] buffer, IOMode mode,
    ...
    override void send(DatagramSocketFD socket, const(ubyte)[] buffer,
            IOMode mode, Address target_address, DatagramIOCallback on_send_finish) {
        assert(false, "TODO!");
    }
