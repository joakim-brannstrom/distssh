...
@safe: /*@nogc:*/ nothrow:
	...
	*/
    ...
    protected void* rawUserData(StreamSocketFD descriptor, size_t size,
            DataInitializer initialize, DataInitializer destroy) @system;
    /// ditto
    protected void* rawUserData(DatagramSocketFD descriptor, size_t size,
            DataInitializer initialize, DataInitializer destroy) @system;

    /** Deprecated - use `EventDriverSockets.userData` instead.
	*/
    deprecated("Use `EventDriverSockets.userData` instead.") @property final ref T userData(T, FD)(
            FD descriptor) @trusted {
...
@safe: /*@nogc:*/ nothrow:
	...
	*/
    StreamSocketFD connectStream(scope Address peer_address,
	...
	*/
    ...
    StreamListenSocketFD listenStream(scope Address bind_address,
	...
	*/
    void write(StreamSocketFD socket, const(ubyte)[] buffer, IOMode mode,
            IOCallback on_write_finish);
	...
	*/
    ...
    bool joinMulticastGroup(DatagramSocketFD socket,
    ...
    void receive(DatagramSocketFD socket, ubyte[] buffer, IOMode mode,
            DatagramIOCallback on_receive_finish);
	...
	*/
    ...
    protected void* rawUserData(StreamSocketFD descriptor, size_t size,
            DataInitializer initialize, DataInitializer destroy) @system;
    /// ditto
    protected void* rawUserData(StreamListenSocketFD descriptor, size_t size,
            DataInitializer initialize, DataInitializer destroy) @system;
    /// ditto
    protected void* rawUserData(DatagramSocketFD descriptor, size_t size,
            DataInitializer initialize, DataInitializer destroy) @system;
...
@safe: /*@nogc:*/ nothrow:
	...
	*/
    ...
    void write(FileFD file, ulong offset, const(ubyte)[] buffer, IOMode mode,
            FileIOCallback on_write_finish);
	...
	*/
    ...
    /** Retrieves a reference to a user-defined value associated with a descriptor.
	*/
    @property final ref T userData(T)(FileFD descriptor) @trusted {
        import std.conv : emplace;
    ...
    protected void* rawUserData(FileFD descriptor, size_t size,
            DataInitializer initialize, DataInitializer destroy) @system;
}
...
@safe: /*@nogc:*/ nothrow:
	...
	*/
    ...
    /** Retrieves a reference to a user-defined value associated with a descriptor.
	*/
    @property final ref T userData(T)(EventID descriptor) @trusted {
        import std.conv : emplace;
    ...
    /// Low-level user data access. Use `userData` instead.
    protected void* rawUserData(EventID descriptor, size_t size,
            DataInitializer initialize, DataInitializer destroy) @system;
}
...
@safe: /*@nogc:*/ nothrow:
	...
	*/
    ...
    /** Retrieves a reference to a user-defined value associated with a descriptor.
	*/
    @property final ref T userData(T)(TimerID descriptor) @trusted {
        import std.conv : emplace;
    ...
    /// Low-level user data access. Use `userData` instead.
    protected void* rawUserData(TimerID descriptor, size_t size,
            DataInitializer initialize, DataInitializer destroy) @system;
}
...
@safe: /*@nogc:*/ nothrow:
	...
	*/
    ...
    /** Retrieves a reference to a user-defined value associated with a descriptor.
	*/
    @property final ref T userData(T)(WatcherID descriptor) @trusted {
        import std.conv : emplace;
    ...
    /// Low-level user data access. Use `userData` instead.
    protected void* rawUserData(WatcherID descriptor, size_t size,
            DataInitializer initialize, DataInitializer destroy) @system;
}
...
final class RefAddress : Address {
    ...
    this(sockaddr* addr, socklen_t addr_len) @safe nothrow {
        set(addr, addr_len);
    }
    ...
    void set(sockaddr* addr, socklen_t addr_len) @safe nothrow {
        m_addr = addr;
        m_addrLen = addr_len;
    }

    void cap(socklen_t new_len) @safe nothrow {
...
alias AcceptCallback = void delegate(StreamListenSocketFD, StreamSocketFD,
        scope RefAddress remote_address);
...
struct Handle(string NAME, T, T invalid_value = T.init) {
    ...
    static if (isInstanceOf!(.Handle, T))
