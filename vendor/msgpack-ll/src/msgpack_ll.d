...
@safe unittest {
    ulong decodeSomeUint(ubyte[] data) {
        ...
        case MsgpackType.posFixInt:
            return parseType!(MsgpackType.posFixInt)(data[0 .. DataSize!(MsgpackType.posFixInt)]);
        case MsgpackType.uint8:
            return parseType!(MsgpackType.uint8)(data[0 .. DataSize!(MsgpackType.uint8)]);
        case MsgpackType.uint16:
            return parseType!(MsgpackType.uint16)(data[0 .. DataSize!(MsgpackType.uint16)]);
        case MsgpackType.uint32:
            return parseType!(MsgpackType.uint32)(data[0 .. DataSize!(MsgpackType.uint32)]);
        case MsgpackType.uint64:
            return parseType!(MsgpackType.uint64)(data[0 .. DataSize!(MsgpackType.uint64)]);
        default:
...
private enum isFixExt(MsgpackType type) = (type == MsgpackType.fixExt1) || (type == MsgpackType.fixExt2)
        || (type == MsgpackType.fixExt4) || (type == MsgpackType.fixExt8)
...
/// ditto
ref ubyte[DataSize!type - 1] parseType(MsgpackType type)(ref ubyte[DataSize!type] data)
        if (isFixExt!type) {
    return data[1 .. $];
}
 ...
 */
void formatType(MsgpackType type)(typeof(null) value, ref ubyte[DataSize!type] data)
        if (type == MsgpackType.nil) {
    formatType!type(data);
}

/// ditto
void formatType(MsgpackType type)(ref ubyte[DataSize!type] data)
        if (type == MsgpackType.nil) {
    data[0] = 0xc0;
}
...
/// ditto
void formatType(MsgpackType type)(bool value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(ubyte value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(byte value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(ushort value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(uint value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(ulong value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(short value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(int value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(long value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(float value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(double value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(ubyte length, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(ushort length, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(uint length, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(ubyte extType, ref ubyte[1] value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(ubyte extType, ref ubyte[2] value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(ubyte extType, ref ubyte[4] value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(ubyte extType, ref ubyte[8] value, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(ubyte extType, ref ubyte[16] value, ref ubyte[DataSize!type] data)
...
@safe unittest {
    ubyte[16] testData = [42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42];
...
/// ditto
void formatType(MsgpackType type)(ubyte length, ubyte extType, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(ushort length, ubyte extType, ref ubyte[DataSize!type] data)
...
/// ditto
void formatType(MsgpackType type)(uint length, ubyte extType, ref ubyte[DataSize!type] data)
