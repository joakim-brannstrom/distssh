...
if (is(M == class))
{
    ...
    if (member != "as" || __traits(hasMember, M, "as"))
    {
...
@safe unittest
{
    ...
    sar.longLineOfIdent1.longLineOfIdent2.as!LongLineOfIdent2.longLineOfIdent3.setFoo(0);
    assert(sar.longLineOfIdent1.longLineOfIdent2.longLineOfIdent3.unwrap.foo == 0);

    class Unrelated {}
    assert(sar.longLineOfIdent1.as!Unrelated.unwrap is null);
}
